  			...
  			<div class="container">
  				...
  				<div class="row align-items-center">
  					...
  					<div class="col-lg-9 col-sm-6 col-8 header-top-right">
  						...
  						<a href="tel:+919876543210"><span class="lnr lnr-phone-handset"></span> <span class="text"><span class="text">+919876543210</span></span></a>

  						<a href="mailto:gla@gmail.com"><span class="lnr lnr-envelope"></span> <span class="text"><span class="text">gla@gmail.com</span></span></a>
...
dolore magna aliqua. Ut enim ad minim veniam.</p>
							...
							<div class="feature_btn">
								...
								<a href="#" class="f_btn">Call Us: 0155-259887
							</div>
...
dolore magna aliqua. Ut enim ad minim veniam.</p>
 ...
 required="" type="email">
                      ...
                      <div class="input-group-btn">
                        ...
                        <button class="genric-btn text-uppercase">get started
 </button>
    ...
    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
